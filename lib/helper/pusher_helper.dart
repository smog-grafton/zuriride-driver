...
class PusherHelper{
  ...
  void driverTripRequestSubscribe(String id){
    if (Get.find<SplashController>().pusherConnectionStatus == 'Connected'){
      ...
      if(driverTripSubscribe.state?.status == null){
  ...
  void customerInitialTripCancel(String tripId, String userId){
    if (Get.find<SplashController>().pusherConnectionStatus == 'Connected'){
      ...
      if(customerInitialTripCancelChannel.state?.status == null){
  ...
  void anotherDriverAcceptedTrip(String tripId, String userId){
    if (Get.find<SplashController>().pusherConnectionStatus == 'Connected'){
      ...
      if(anotherDriverAcceptedTripChannel.state?.status == null){
        anotherDriverAcceptedTripChannel.subscribeIfNotUnsubscribed();
  ...
  void tripCancelAfterOngoing(String tripId){
    if (Get.find<SplashController>().pusherConnectionStatus == 'Connected'){
      ...
      if(tripCancelAfterOngoingChannel.state?.status == null){
        tripCancelAfterOngoingChannel.subscribeIfNotUnsubscribed();
  ...
  void tripPaymentSuccessful(String tripId){
    if (Get.find<SplashController>().pusherConnectionStatus == 'Connected'){
      ...
      if(tripPaymentSuccessfulChannel.state?.status == null){
        tripPaymentSuccessfulChannel.subscribeIfNotUnsubscribed();
