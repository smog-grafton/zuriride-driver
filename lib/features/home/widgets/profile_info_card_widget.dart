                ...
                child: Row(children: [
                          ...
                          if (widget
                            ...
                            JustTheTooltip(
                              ...
                              child: Container(
                                ...
                                padding:
                                    EdgeInsets.all(Dimensions.paddingSizeTiny),
                        ...
                        if (Get.find<SplashController>().config!.levelStatus!)
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                widget.profileController.profileInfo!.level !=
                                        null
                                    ? widget.profileController.profileInfo!
                                        .level!.name!
                                    : '',
                  ...
                  FlutterSwitch(
                      ...
                      toggleBorder: Border.all(
                          width: 5, color: Colors.white.withValues(alpha: .75)),
