      ...
      child: PopScope(
        ...
        child: Scaffold(
            ...
            body: GetBuilder<RideController>(builder: (rideController) {
              return (rideController.ongoingRideList == null ||
                      (rideController.ongoingRideList ?? []).isEmpty)
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return _TripCardWidget(
                            rideController.ongoingRideList![index]);
                      });
            })),
      ),
    );
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color:
                      Theme.of(Get.context!).primaryColor.withValues(alpha: .1),
                  blurRadius: 1,
                  spreadRadius: 1,
                        ...
                        child: Row(children: [
                          if (rideRequest.currentStatus ==
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color:
                                    context.customThemeColors.upComingTagColor,
...
void _checkDriverNeedSafety(TripDetail tripDetails) {
  if (tripDetails.driverSafetyAlert != null) {
    Get.find<SafetyAlertController>()
        .updateSafetyAlertState(SafetyAlertState.afterSendAlert);
  } else {
