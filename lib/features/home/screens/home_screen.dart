                ...
                return profileController.profileInfo != null
                    ? Column(
                        ...
                        children: [
                            ...
                            if ((!(profileController.profileInfo?.isVerified ??
                                        false) ||
                                    ((profileController
                                                .profileInfo?.isSuspended ??
                                            false) &&
                                        (profileController
                                                .profileInfo?.suspendReason ==
                                            'face_verification')) ||
                                    (profileController
                                            .profileInfo?.needVerification ??
                                        false)) &&
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.all(
                                    ...
                                    .copyWith(bottom: 0),
                                child: Row(children: [
                                  Image.asset(Images.nonVerificationIcon,
                                      height: 25, width: 25),
                                  const SizedBox(
                                  ...
                                  InkWell(
                                    onTap: () =>
                                        Get.find<FaceVerificationController>()
              ...
              parcelCount > 0 && _isShowRideIcon
                  ? Padding(
                      ...
                      child: JustTheTooltip(
                        ...
                        child: InkWell(
                          onTap: () => Get.to(() => const ParcelListScreen(
