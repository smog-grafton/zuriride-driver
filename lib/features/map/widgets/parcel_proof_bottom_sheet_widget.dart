    ...
    return Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(
          ...
          child: Text(
              'Please upload a photo to give proof as you taken the parcel delivery',
        ...
        Row(children: [
          SizedBox(
            ...
            child: InkWell(
              onTap: () => Get.find<OtpTimeCountController>()
                  .pickProofImage(ImageSource.camera, froPickupImage),
          ...
          SizedBox(
            ...
            child: InkWell(
              onTap: () => Get.find<OtpTimeCountController>()
                  .pickProofImage(ImageSource.gallery, froPickupImage),
              child: Column(children: [
                Container(
                  height: 60,
                  width: 60,
