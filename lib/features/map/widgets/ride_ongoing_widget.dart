                  ...
                  child: Column(
                      ...
                      children: [
                          ...
                          child: !Get.find<SplashController>()
                              ...
                              : RichText(
                                  text: TextSpan(
                                      ...
                                      TextSpan(
                                        text:
                                            ' ${Get.find<SplashController>().config?.parcelReturnTime} ',
                                        style: textBold.copyWith(
                                            fontSize:
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(
                              horizontal: Dimensions.paddingSizeDefault),
                          child: Text('parcel_return_time'.tr,
                              style: textBold.copyWith(
                                  fontSize: Dimensions.fontSizeDefault)),
                        ),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
                                ...
                                onPressed: () {
                                  if (!Get.find<SplashController>()
                                    ...
                                    DateTime pickedDateTime = DateTime.parse(
                                        '${Get.find<TripController>().parcelReturnDate} ${Get.find<TripController>().parcelReturnTime}');
                                    Duration duration = pickedDateTime
                                        .difference(DateTime.now());
                                    if (duration.isNegative) {
                                      showCustomSnackBar(
                                          'selected_time_is_in_the_past'.tr);
                                    } else if (duration.inHours >
                                        (Get.find<SplashController>()
                                                    .config
                                                    ?.parcelReturnTimeType ==
                                                'day'
                                            ? ((Get.find<SplashController>()
                                                        .config
                                                        ?.parcelReturnTime ??
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return UserDetailsWidget(
                    name: rideController
                            .tripDetail?.parcelUserInfo![index].name ??
                        '',
                    contactNumber: rideController
                            .tripDetail?.parcelUserInfo![index].contactNumber ??
                        '',
                    type: rideController
                            .tripDetail?.parcelUserInfo![index].userType ??
                        '',
                  );
                },
              ),
            if (rideController.tripDetail?.type == 'parcel' &&
                (rideController.tripDetail?.isParcelDeliveryProofEnable ??
                    false)) ...[
                        ...
                        SliderButton(
                          action: () {
                            if ((rideController.tripDetail
                              ...
                              if (rideController.tripDetail!.parcelInformation!
                                          .payer ==
                                      AppConstants.sender &&
