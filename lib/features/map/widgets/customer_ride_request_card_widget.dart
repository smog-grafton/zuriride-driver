  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      Get.find<RideController>().matchedMode != null
          ...
          : const SizedBox(),
      if (rideRequest.pickupNote != null &&
          rideRequest.pickupNote!.isNotEmpty) ...[
