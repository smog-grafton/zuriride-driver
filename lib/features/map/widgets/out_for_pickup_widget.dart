...
class _AcceptedTripWidget extends StatefulWidget {
  ...
  const _AcceptedTripWidget(
      {required this.callBack, required this.expandBottomSheet});
      ...
      return GetBuilder<RideController>(builder: (rideController) {
        ...
        return Padding(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: Dimensions.paddingSizeDefault),
            if (rideController.tripDetail?.pickupNote != null &&
                (rideController.tripDetail?.pickupNote ?? '').isNotEmpty) ...[
              Padding(
                padding: const EdgeInsets.symmetric(
                    horizontal: Dimensions.paddingSizeDefault),
                child: Container(
