...
class ParcelProofImageView extends StatefulWidget {
  ...
  const ParcelProofImageView(
      {super.key, required this.proofImages, required this.isPickupProofImage});
...
class _ParcelProofImageViewState extends State<ParcelProofImageView> {
  ...
  void initState() {
    ...
    for (final image in widget.proofImages) {
