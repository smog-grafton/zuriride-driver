                  ...
                  Flexible(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          if (((rideController.tripDetail?.pickupProofImages ??
                                      [])
                                  .isNotEmpty) &&
                              rideController.tripDetail?.type == 'parcel') ...[
                            ParcelProofImageView(
                                proofImages: rideController
                                        .tripDetail?.pickupProofImages ??
                                    [],
                                isPickupProofImage: true),
                            const SizedBox(height: Dimensions.paddingSizeSmall)
                          ],
                          if (((rideController
                                          .tripDetail?.deliveryProofImages ??
                                      [])
                                  .isNotEmpty) &&
                              rideController.tripDetail?.type == 'parcel') ...[
                            ParcelProofImageView(
