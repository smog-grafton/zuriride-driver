  ...
  Future<void> _loadVideo() async {
    ...
    if (widget.fromNetwork) {
      if (widget.attachments != null &&
          widget.attachments!.length > currentIndex) {
        path = widget.attachments![currentIndex].file;
      }
    } else {
      if (widget.proofImages != null &&
          widget.proofImages!.length > currentIndex) {
          ...
          itemBuilder: (context, index) {
            String? path = widget.fromNetwork
                ? (widget.attachments != null &&
                        widget.attachments!.length > index
                    ? widget.attachments![index].file
                    : null)
                : (widget.proofImages != null &&
                        widget.proofImages!.length > index
                    ? widget.proofImages![index].path
                    : null);
            ...
            return Column(children: [
              ...
              isVideo
                  ? Flexible(
                      child: Center(
                          child:
                              (index == currentIndex && chewController != null)
