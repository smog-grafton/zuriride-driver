...
class TripDetail {
  ...
  TripDetail.fromJson(Map<String, dynamic> json) {
    ...
    isPaused = json['is_paused'] != null
        ...
        : null;
    isReachedDestination = json['is_reached_destination'] != null
        ? (json['is_reached_destination'].toString() == '1' ||
            json['is_reached_destination'].toString() == 'true')
        : false;
    isLoading = false;
    isReviewed = json['customer_review'] != null
        ? (json['customer_review'].toString() == '1' ||
            json['customer_review'].toString() == 'true')
        : null;
    ...
    isParcelDeliveryProofEnable =
        json['is_parcel_delivery_proof_enabled'] != null
            ? (json['is_parcel_delivery_proof_enabled'].toString() == '1' ||
                json['is_parcel_delivery_proof_enabled'].toString() == 'true')
            : null;
  }
}
...
class ParcelRefund {
  ...
  ParcelRefund.fromJson(Map<String, dynamic> json) {
    ...
    parcelApproximatePrice =
        double.tryParse(json['parcel_approximate_price'].toString());
    reason = json['reason'];
    ...
    note = json['note'];
    refundAmountByAdmin =
        double.tryParse(json['refund_amount_by_admin'].toString());
...
class DriverSafetyAlert {
  ...
  DriverSafetyAlert.fromJson(Map<String, dynamic> json) {
    ...
    numberOfAlert = json['number_of_alert'] != null
        ? int.tryParse(json['number_of_alert'].toString())
        : null;
