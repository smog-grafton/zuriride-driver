class RemainingDistanceModel {
  ...
  RemainingDistanceModel.fromJson(Map<String, dynamic> json) {
    ...
    isPicked = json['is_picked'] != null
        ? (json['is_picked'].toString() == '1' ||
            json['is_picked'].toString() == 'true')
        : null;
    isDrop = json['is_dropped'] != null
        ? (json['is_dropped'].toString() == '1' ||
            json['is_dropped'].toString() == 'true')
        : null;
    durationInTraffic = json['duration_in_traffic'];
    durationInTrafficSec = json['duration_in_traffic_sec'] != null
        ? int.tryParse(json['duration_in_traffic_sec'].toString())
        : null;
  }
}
