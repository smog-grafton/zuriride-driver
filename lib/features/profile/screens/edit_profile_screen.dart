...
class ProfileEditScreenState extends State<ProfileEditScreen>
  ...
  void initState() {
    ...
    Get.find<AuthController>().setIdentityType(
        widget.profileInfo?.identificationType ?? '',
        isUpdate: false);
    Get.find<AuthController>().setGender(
        widget.profileInfo?.gender ?? 'select_gender',
        isUpdate: false);
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      TextFieldTitleWidget(
                          title: 'identification_number'.tr, isRequired: true),
                      TextFieldWidget(
                        hintText: 'Ex: 12345',
                      ...
                      TextFieldTitleWidget(
                          title: 'gender'.tr, isRequired: true),
                      Container(
                        padding: const EdgeInsets.symmetric(
                            horizontal: Dimensions.paddingSizeDefault),
                        decoration: BoxDecoration(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(
                            child: DropdownButton<String>(
                              ...
                              items:
                                  authController.genderList.map((String value) {
                                return DropdownMenuItem<String>(
                                  value: value,
                                  child: Text(value.tr,
                                      style: textRegular.copyWith(
                                        color: value == 'select_gender'
                                            ? Theme.of(context)
                                                .textTheme
                                                .bodyMedium
                                                ?.color
                      ...
                      if (profileController.additionalFields.isNotEmpty) ...[
                        TextFieldTitleWidget(
                            title: 'provide_additional_info'.tr),
                        ListView.builder(
                          shrinkWrap: true,
                          physics: const NeverScrollableScrollPhysics(),
                          ...
                          itemBuilder: (context, index) {
                            return UpdateAdditionalFieldWidget(
                              fieldModel:
                                  profileController.additionalFields[index],
                              index: index,
                            );
                          },
                        )
                        ...
                        onPressed: () {
                          ...
                          if (fName.isEmpty) {
                            ...
                            final String? invalidField =
                                profileController.validateAdditionalFields();
                            if (invalidField != null) {
                              showCustomSnackBar(
                                  '${titleFormatedName(invalidField)} ${'is_required'.tr}');
                              return;
                            }
