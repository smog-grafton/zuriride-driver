...
class ProfileController extends GetxController implements GetxService {
  ...
  final Map<String, String> _additionalFieldPhoneCountryCodes = {};
      ...
      if (field.fieldType == AdditionalFieldType.checkbox) {
        if (field.options?.isNotEmpty == true) {
          ...
          profileInfo?.additionalData?.forEach((additionData) {
            if (additionData.title == field.title &&
                additionData.type == field.fieldType.name) {
          ...
          profileInfo?.additionalData?.forEach((additionData) {
            if (additionData.title == field.title &&
              ...
              _additionalFieldCheckValues[field.id] =
                  (additionData.value?.isNotEmpty == true &&
                      additionData.value![0] == '1');
            }
          });
        }
        ...
        profileInfo?.additionalData?.forEach((additionData) {
          if (additionData.title == field.title &&
            ...
            if (field.fieldType == AdditionalFieldType.phone &&
                phoneWithCountry.isNotEmpty) {
              String? countryCode =
                  CountryCodeHelper.getCountryCode(phoneWithCountry);
              if (countryCode != null) {
                _additionalFieldPhoneCountryCodes[field.id] = countryCode;
                _additionalFieldControllers[field.id]?.text =
                    phoneWithCountry.substring(countryCode.length);
              } else {
