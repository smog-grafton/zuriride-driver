...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    completedCurrentLevelTarget = json['completed_current_level_target'] != null
        ...
        : null;
    isCompleted = json['level_completed'] != null
        ? (json['level_completed'].toString() == '1' ||
            json['level_completed'].toString() == 'true')
        : null;
  }
}
...
class NextLevel {
  ...
  NextLevel.fromJson(Map<String, dynamic> json) {
    ...
    targetedAmountPoint =
        double.tryParse(json['targeted_amount_point'].toString());
    targetedCancel = double.tryParse(json['targeted_cancel'].toString());
    targetedCancelPoint =
        double.tryParse(json['targeted_cancel_point'].toString());
    targetedReview = double.tryParse(json['targeted_review'].toString());
    targetedReviewPoint =
        double.tryParse(json['targeted_review_point'].toString());
...
class CompletedCurrentLevelTarget {
  ...
  CompletedCurrentLevelTarget.fromJson(Map<String, dynamic> json) {
    ...
    earningAmountPoint =
        double.tryParse(json['earning_amount_point'].toString());
    cancellationRatePoint =
        double.tryParse(json['cancellation_rate_point'].toString());
  }
}
