...
import 'package:ride_sharing_user_app/features/auth/screens/otp_sign_up_screen_2.dart';
            ...
            Container(
              ...
              child: ButtonWidget(
                ...
                onPressed: () {
                  ...
                  } else if (authController.fNameController.text
                      .trim()
                      .isEmpty) {
                    showCustomSnackBar('first_name_is_required'.tr);
                    FocusScope.of(context)
                        .requestFocus(authController.fNameNode);
                  } else if (authController.selectedGender.isEmpty ||
                      authController.selectedGender == 'select_gender') {
                    showCustomSnackBar('required_the_gender'.tr);
                  } else {
                    Get.to(() =>
                        OtpSignUpScreen2(phoneNumber: widget.phoneNumber));
                  }
                },
              ),
            ),
