...
class BiometricLoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Text('back_to_previous_page'.tr,
              ...
              child: Center(
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(Images.biometricIcon,
                        height: 60, width: 60),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Text('click_on_the_round_icon_to_logging'.tr,
                      textAlign: TextAlign.center),
                )
              ])),
            )
          ]),
          if (authController.isLoading) LoaderWidget(),
        ]);
      }),
    );
  }
