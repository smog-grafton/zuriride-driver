...
class AdditionalSignUpScreen3 extends StatefulWidget {
  ...
  @override
  State<AdditionalSignUpScreen3> createState() =>
      _AdditionalSignUpScreen3State();
}
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'enter_the_additional_details_to_complete_the_signup'
                            .tr,
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            return AdditionalFieldWidget(
                              fieldModel:
                                  authController.additionalFields[index],
                              index: index,
                            );
                          },
                        ),
