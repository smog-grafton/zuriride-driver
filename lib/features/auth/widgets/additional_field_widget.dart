    ...
    return GetBuilder<AuthController>(
      builder: (authController) => switch (fieldModel.fieldType) {
        ...
        AdditionalFieldType.textarea =>
          _TextInputField(
              fieldModel: fieldModel, authController: authController),
        AdditionalFieldType.phone => _PhoneInputField(
            fieldModel: fieldModel, authController: authController),
        AdditionalFieldType.date =>
          _DateField(fieldModel: fieldModel, authController: authController),
        AdditionalFieldType.file =>
          _FileField(fieldModel: fieldModel, authController: authController),
        AdditionalFieldType.checkbox => _CheckboxField(
            fieldModel: fieldModel, authController: authController),
        AdditionalFieldType.radio =>
          _RadioField(fieldModel: fieldModel, authController: authController),
  ...
  Widget build(BuildContext context) {
    return _FieldColumn(
      ...
      child: TextFieldWidget(
        ...
        inputAction: TextInputAction.next,
        countryDialCode:
            authController.additionalFieldPhoneCountryCodes[fieldModel.id],
        onCountryChanged: (code) => authController
...
class _DateField extends StatelessWidget {
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null) {
      ...
      authController.additionalFieldControllers[fieldModel.id]?.text =
          formatted;
      ...
      child: GestureDetector(
        ...
        child: AbsorbPointer(
          child: CustomTextField(
            ...
            controller:
                authController.additionalFieldControllers[fieldModel.id],
            focusNode: authController.additionalFieldFocusNodes[fieldModel.id],
            inputAction: TextInputAction.next,
            prefix: false,
            read: true,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: FileUploadFieldWidget(
        ...
        onFilesSelected: (List<XFile> files) =>
            authController.setAdditionalFieldFile(fieldModel.id, files),
      ),
    );
  }
}
...
class _CheckboxField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedOptions =
        (authController.additionalFieldCheckValues[fieldModel.id] as List?) ??
            [];
          ...
          return _OptionRow(
            ...
            leading: _CheckBox(
              ...
              onChanged: (value) {
                ...
                authController.setAdditionalFieldCheckValue(
