...
class BiometricAuthBottomSheetWidget extends StatefulWidget {
  ...
  @override
  State<BiometricAuthBottomSheetWidget> createState() =>
      _BiometricAuthBottomSheetWidgetState();
}

class _BiometricAuthBottomSheetWidgetState
    extends State<BiometricAuthBottomSheetWidget> {
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Image.asset(isBiometricListEmpty
                        ? Images.biometricIcon
                        : Images.biometricPassword),
                  ),
                  ...
                  if (isBiometricListEmpty) ...[
                    Padding(
                      ...
                      child: Text(
                        'please_set_up_face_id_or_fingerprint_on_your_device'
                            .tr,
                        style: textSemiBold,
                      ...
                      onPressed: () {
                        if (_passwordController.text.isNotEmpty) {
                          if (authController.isBiometricEnable) {
                            authController.setBiometricEnable(
                                false, _passwordController.text.trim());
                          } else {
                            authController.setBiometricEnable(
                                true, _passwordController.text.trim());
                          }
                        }
                      },
                      radius: 50,
