              ...
              Container(width: widget.prefixHeight, height: 50,
                ...
                child: Center(
                  child: CodePickerWidget(
                    ...
                    // Uganda only — matches admin default country (ISO 3166-1 alpha-2: UG).
                    // See: https://drivemond.app/documentation/driver-app-setup/customization/
                    countryFilter: const ['UG'],
                    favorite: [
                      if (widget.countryDialCode != null &&
                          widget.countryDialCode!.isNotEmpty)
